# Contributing to `toolhive-doc-mcp` <!-- omit from toc -->

First off, thank you for taking the time to contribute to the ToolHive Doc
MCP! :+1: :tada: Toolhive Doc MCP is released under the Apache 2.0 license.
...
development in toolhive-doc-mcp's
[README](https://github.com/StacklokLabs/toolhive-doc-mcp/blob/main/README.md).
...
[Contributor Covenant](https://github.com/StacklokLabs/toolhive-doc-mcp/blob/main/CODE_OF_CONDUCT.md)
...
If you think you have found a security vulnerability in toolhive-doc-mcp please DO
...
[process](https://github.com/StacklokLabs/toolhive-doc-mcp/blob/main/SECURITY.md)
...
["good first issue"](https://github.com/StacklokLabs/toolhive-doc-mcp/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
...
- Fork the toolhive-doc-mcp repository to your own GitHub account and clone it
  locally.
...
- Every pull request requires a review from the core toolhive-doc-mcp team before
  merging.
